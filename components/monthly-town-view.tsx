  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`relative flex h-[74px] w-full items-end justify-center rounded-xl border border-white/70 bg-gradient-to-b from-slate-50 to-slate-100 p-1 shadow ${selected ? "ring-2 ring-quest-primary" : ""}`}
      >
